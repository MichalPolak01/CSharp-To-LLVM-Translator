...
public partial class MathBaseListener : IMathListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterTerm([NotNull] MathParser.TermContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MathParser.term"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitTerm([NotNull] MathParser.TermContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterFactor([NotNull] MathParser.FactorContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MathParser.factor"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitFactor([NotNull] MathParser.FactorContext context) { }
